...
@RoutePage()
class SliderSettingsScreen extends StatefulWidget {
  const SliderSettingsScreen({super.key});

  @override
  State<SliderSettingsScreen> createState() => SliderSettingsScreenState();
}

class SliderSettingsScreenState extends State<SliderSettingsScreen> {
  @override
